...
#SBATCH --output=/scratch/alpine/%u/ksl-dir-2/slurm/v33_%j.out
#SBATCH --error=/scratch/alpine/%u/ksl-dir-2/slurm/v33_%j.err
#SBATCH --account=ucb765_asc1
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=hama5612@colorado.edu

# ==============================================================================
# V33 KD Training - Numbers
...
python train_ksl_v33.py --model-type numbers --seed 42 \
  --checkpoint-dir data/checkpoints/v33b

echo ""
echo "=========================================="
echo "V33 Numbers Complete"
echo "End time: $(date)"
echo "=========================================="
