...
#SBATCH --output=/scratch/alpine/%u/ksl-dir-2/slurm/v30_train_numbers_%j.out
#SBATCH --error=/scratch/alpine/%u/ksl-dir-2/slurm/v30_train_numbers_%j.err
#SBATCH --account=ucb765_asc1
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=hama5612@colorado.edu

# ==============================================================================
# V30 Phase 2 Training - NUMBERS ONLY
# ==============================================================================

set -e

echo "=========================================="
echo "KSL V30 Phase 2 Training - NUMBERS ONLY"
echo "=========================================="
...
python train_ksl_v30.py --model-type numbers $COMMON_FLAGS --seed 42

echo ""
echo "=========================================="
echo "V30 Numbers Training Complete"
echo "End time: $(date)"
echo "=========================================="
